          ...
          <div class="bs-example1" data-example-id="contextual-table">
            <table class="table">
              ...
              if(count($json[0]->teams)>0) {
                  ...
                  echo "<tr class='warning'>";
                  echo "<td colspan='4'> <a href='http://"?><?php echo get_website_host()?><?php get_website_relative_path()?><?php echo "/create-team' style=\"color:red;text-decoration:none;font-size:20px\">Create a New Team </a> or <a href='http://"?><?php echo get_website_host()?><?php get_website_relative_path()?><?php echo "/search-teams' style=\"color:red;text-decoration:none;font-size:20px\"> Join an Existing Team</a></td>";
                  echo "</tr>";
